...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, custom ="FANZGTNG") => {
        authState.creds.pairingCode = custom ? custom.toUpperCase() : (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
        authState.creds.me = {
